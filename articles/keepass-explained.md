...
秘密鍵ファイルを削除する場合、代わりに公開鍵を指定することでエージェントが保持しているキーを指定して使わせることができます。([OpenSSHの関連PR](https://github.com/openssh/openssh-portable/pull/215))
```
# in ~/.ssh/config
...
例え使わないにしても、こうしたものが世の中に既にあると理解しておくと、よりよいデータ管理に結びつけることができると思います。  
